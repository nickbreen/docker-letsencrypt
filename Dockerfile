...
RUN apt-get update && DEBIAN_FRONTEND=noninteractive apt-get install -y jq python-pip letsencrypt lighttpd && DEBIAN_FRONTEND=noninteractive apt-get -y upgrade && apt-get clean
